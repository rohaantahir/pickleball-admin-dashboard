...
export default function Members() {
  ...
  const getTierColor = (tier: Member['membershipTier']) => {
    switch (tier) {
      case 'Rally Pass': return 'bg-blue-100 text-blue-800 hover:bg-blue-100';
      case 'Match Point': return 'bg-primary/10 text-primary hover:bg-primary/10';
      case 'Tour Insider': return 'bg-accent/10 text-accent hover:bg-accent/10';
